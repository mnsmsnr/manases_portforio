...
export const ParallaxSticky = () => {
    ...
    const sub = {1:'大きな事件もなく幼少期を過ごす',
            ...
            16.5:'宿泊施設予約システム開発',
            16.51:'[PHP][Vue.js][Nuxt.js][Vuetify][Laravel(Blade)][MySQL][BitBucket][virtualBox][保守・機能拡張]\n' +
                'バックエンド知見をフックにモダン環境でのフロント開発、また、独自FWや独特なアプリケーション構成を経験',
            16.7:'PJ管理システム開発',
            16.71:'[Nuxt.js][Vue.js][Vuetify][Jest][Docker][Java][Gradle][GitHub][新規開発]\n' +
                'オフショア開発体制・外部packagePOC・vue2から3へのVerup等を新規開発を通して経験。',
            16.9:'自治体施設予約システム開発',
            16.91:'[Nuxt.js][Vue.js][Vuetify][TypeScript][Docker][Gradle][BitBucket][新規開発] \n' +
                '開発環境の改善・デザインFWの移行を経験。 ※現在参画中',
        }
